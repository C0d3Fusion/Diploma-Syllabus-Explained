...
<head>
    ...
    <style>
        ...
        b {
            color: #e74c3c; /* For highlighting key terms */
        }
        .formula-box {
            ...
            padding: 12px 15px;
            margin: 15px 0;
            font-family: 'Consolas', 'Courier New', monospace; /* Monospace font for formulas */
            ...
            border-radius: 5px;
            text-align: center; /* Center the formula text */
        }
        .section-divider {
